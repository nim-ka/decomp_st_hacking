...
const Collision bowser_3_seg7_collision_level_hack[] = {
    COL_INIT(),
    COL_VERTEX_INIT(0x18),
    COL_VERTEX(-8191, -4543, 8192),
    COL_VERTEX(8192, -4543, 8192),
    COL_VERTEX(8192, -4543, -8191),
    COL_VERTEX(-8191, -4543, -8191),
...
const Collision bob_seg7_collision_level_hack[] = {
    COL_INIT(),
...
const MacroObject bob_seg7_macro_objs_hack[] = {
...
// 0x16000EA0
const GeoLayout trans_star_geo_hack[] = {
